...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(182, 127);
			...
			this->label6->Location = System::Drawing::Point(82, 50);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(363, 29);
			this->label6->TabIndex = 12;
			this->label6->Text = L"Selamat datang di toko kami!!!";
			...
			this->checkBox1->Size = System::Drawing::Size(101, 20);
			this->checkBox1->TabIndex = 11;
			this->checkBox1->Text = L"I\'m not robot";
			...
			this->ClientSize = System::Drawing::Size(467, 544);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	if (textBox1->Text == "may") {
		if (textBox2->Text == "123") {
			/*MessageBox::Show("Access Granted", "Log In", MessageBoxButtons::OK, MessageBoxIcon::Information);*/
			this->Hide();
			MyForm1 obj;
			obj.ShowDialog();
			Application::Exit();
